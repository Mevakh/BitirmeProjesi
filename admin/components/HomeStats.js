    ...
    <div>
      ...
      <div className="tiles-grid">
        <div className="tile">
          ...
          <div className="tile-desc">{ordersToday.length} Bugünkü siparişler</div>
        </div>
        <div className="tile">
          <h3 className="tile-header">Bu hafta</h3>
          <div className="tile-number">{ordersWeek.length}</div>
          <div className="tile-desc">{ordersWeek.length} Bu haftaki siparişler</div>
        </div>
        <div className="tile">
          <h3 className="tile-header">Bu ay</h3>
          <div className="tile-number">{ordersMonth.length}</div>
          <div className="tile-desc">{ordersMonth.length} Bu ayki siparişler</div>
        </div>
      </div>
      <h2>Gelir</h2>
      <div className="tiles-grid">
